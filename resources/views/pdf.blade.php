...
<head>
    ...
    <title>{{ config('nova-reporter.name') }}</title>
    ...
    <header >
        <table style="width: 100%;">
            <tbody>
                <tr>
                    <td style="width: 50%;">
                        @if(!empty($config['image']) && file_exists($config['image']))
                            <img src="{{ $config['image'] }}" alt="image" style="width: 100px;">
                        @else
                            <span style="font-size: 24px; font-weight: 600; text-transform: uppercase;">
                                {{ config('nova-reporter.name') }}
                            </span>
                        @endif
                    </td>
                    <td style="width: 50%; text-align: right;">
                        <span style="font-size: 22px; font-weight: 600; text-transform: uppercase;">
